...
function executorLaunchLog() {
    echo "<div class='list'>";
    echo "<h3>Executor Log Launch</h3>";
    echo "<table style='font-size:10pt'>";

    build_table_headers("executorloglaunch");

    $q = "select * from executorloglaunch order by date_ desc limit 100";
